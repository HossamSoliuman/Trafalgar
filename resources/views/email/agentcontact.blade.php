...
<html>
<head>
 <title>Enquiry for Property - {{ $details['property_id'] }}</title>
</head>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;border-color: #ddd;">
                                                                            <tbody>
                                            @if($details['pageName'] == 'propertydetail')                                      <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Property ID</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{ $details['property_id'] }}</td>
                                                                                </tr>
                                             @endif                                        
                                                                                   @if($details['propertyHeading'] != '')
                                                                                            <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Property Name</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{  $details['propertyHeading'] }}</td>
                                                                                </tr>
                                                                                @endif
                                                                                 @if($details['propertyaddress'] != '')
                                                                                    ...
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{  $details['propertyaddress'] }}</td>
                                                                                </tr>
                                                                                @endif
                                                                                
                                                                                <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Name</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{ ucfirst($details['username']) }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                @if($details['pageurl'] != '')
                                                                                            <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Page URL</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{  $details['pageurl'] }}</td>
                                                                                </tr>
                                                                                @endif
                                                                               
                                                                                
                                                                                  @if($details['pageName'] == 'propertydetail')       
                                                  <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Arrange viewing</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{ ucfirst($details['arrange_viewing']) }}</td>
                                                                                </tr>
                                             
                                              <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Date</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{ $details['contact_date'] }}</td>
                                                                                </tr>
                                                                                
                                                                                 <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Time</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{ $details['contact_time'] }}</td>
                                                                                </tr>
