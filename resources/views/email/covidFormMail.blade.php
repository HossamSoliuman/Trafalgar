                                                                    ...
                                                                    <td>
                                                                        <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;border-color: #ddd;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">City</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{  $details['city'] }}</td>
                                                                                </tr>
                                                                                
                                                                                <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Building name</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{  $details['building_name'] }}</td>
                                                                                </tr>
                                                                                <tr>
