                                                                    ...
                                                                    <td>
                                                                        <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;border-color: #ddd;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Method of Contact </th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{  $details['method_of_contact'] }}</td>
                                                                                </tr>
                                                                                
                                                                                <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Time to Call </th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{  $details['time_to_call'] }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;vertical-align: baseline;">Comment/Question</th>
