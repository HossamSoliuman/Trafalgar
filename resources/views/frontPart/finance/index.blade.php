            ...
            <div class="guldenland_products">
                ...
                <div class="guldenland_sidebar">
                    ...
                    <div class="sidelist">
                        ...
                        <ul>
                            <li><a href="{{ asset('storage/trafalgarCretificate/financial-services-board.pdf') }}">Financial
                                    Services Board</a></li>
                            <li><a
                                    href="{{ asset('storage/trafalgarCretificate/Trafalgar-Financial-Services-NCR-Certificate-2021.pdf') }}">Registered
                                    Credit Provider</a></li>
                            <li><a href="{{ asset('storage/trafalgarCretificate/FIA_Membership_Certificate.tif') }}">FIA
