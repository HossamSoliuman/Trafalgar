@php $pageMeta = App\Models\StaticPageMetaTag::where('page_name','pretoria.property-to-rent-pretoria-north')->first(); @endphp
    ...
    <section class="guldenland_section about_page_content mt-2">
        <div class="container">
            <div class="heading h1_tag mb-4">
                <h1>Property To Rent In Pretoria North, Pretoria</h1>
            </div>
            <div class="guldenland_products">
                <div class="guldenland_products_listing manage_section_listing1">
                    <div class="each_manage_section manage-paragraph">
                        <div class="more-content">
                     <p>We have the following property to rent in Pretoria North in Pretoria.<p>
						 <div class="more">
