   ...
   <div class="container p-0">
      <div class="row align-items-center m-0">
         <div class="col-12 col-lg-12 p-0">
            ...
            <div class="property-section-content">
               <div class="property-tabs__reset mb-3 d-flex align-items-center justify-content-between">
                  <ul class="nav nav-pills" id="pills-tab" role="tablist">
                     <li class="nav-item search-panel">
                        <a class="nav-link <?php if((isset($_GET['tab']) && $_GET['tab'] =="rent" ) ){ echo "active";}else if(!isset($_GET['tab'])){ echo "active";} ?>" id="pills-home-tab"  href="{{ route('/',['tab'=>'rent']) }}"
                           role="tab" aria-controls="pills-home" aria-selected="true" >To Rent</a>
                     </li>
                     <li class="nav-item search-panel">
                        <a class="nav-link <?php if((isset($_GET['tab']) && $_GET['tab'] =="sale" ) ){ echo "active";} ?>" id="pills-profile-tab"  href="{{ route('/',['tab'=>'sale']) }}"
                           role="tab" aria-controls="pills-profile" aria-selected="false" >For Sale</a>
                     </li>
                     <li class="nav-item search-panel">
                        <!--Durban, Kwazulu Natal-->
                        <!--'Port Elizabeth,Eastern Cape'-->
                        <a class="nav-link" id="pills-contact-tab"  href="{{ route('commercial-property',['city' => 'Durban,Kwazulu Natal']) }}"
               ...
               <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade <?php if((isset($_GET['tab']) && $_GET['tab'] =="rent" ) ){ echo "show active";}else if(!isset($_GET['tab'])){ echo "show active";} ?>" id="pills-home" role="tabpanel"
                     aria-labelledby="pills-home-tab">
                     <div class="content">
                        <form  method="get" id="formRentTypeSubmit" class="resetFormData">
                           <div class="input-group mb-3 search_view">
                              <select id="cityrent"  class="select2 form-control search-input" multiple="multiple" onchange="getData()"></select>
                              <div class="input-group-append">
                                 <button data-formtype="formRentTypeSubmit" data-citydata="cityrent" class="btn btn-outline-secondary search-btn submitSearchData button-addon2" type="button"
                                    >Search</button>
                              </div>
                           </div>
                            <input type="hidden" name="city" class="stringCity">
                            <input type="hidden" name="ptype" id="stringPropertyTypeRent" class="stringPropertyTypeRent">
                           ...
                           <div class="select_buttons mb-3">
                              <div class="single_select_buttons select_icon">
                                 <select id="ptype_rent" multiple="multiple"  class="form-select ptype_select" aria-label="Default select example">
                                    ...
                                    <option  value="{{ $propertyTypeListss->property_type  }}">{{ ucfirst($propertyTypeListss->property_type)  }}</option>
                                @endforeach
                                 </select>
                              </div>
                              <div class="single_select_buttons select_icon">
                                 <select id="minprice_rent" name="minprice" class="form-select" aria-label="Default select example">
                              ...
                              <div class="single_select_buttons select_icon">
                                 <select name="bath" id="bath_rent" class="form-select" aria-label="Default select example">
                  ...
                  <div class="tab-pane fade <?php if((isset($_GET['tab']) && $_GET['tab'] =="sale" )  ){ echo "show active";} ?>" id="pills-profile" role="tabpanel"
                     aria-labelledby="pills-profile-tab">
                     <div class="content">
                        <form action="{{ route('property') }}" method="get" id="formSaleTypeSubmit" class="resetFormData">
                           <div class="input-group mb-3 search_view">
                              <select id="citysale" class="select2 form-control search-input" multiple="multiple" onchange="getData1()">
                                 
                              </select>
                              <div class="input-group-append">
                                 <button  data-citydata="citysale" class="btn btn-outline-secondary search-btn submitFormForSaleProperty button-addon2" type="button"
                                    >Search</button>
                              </div>
                           </div>
                           <input type="hidden" name="ptype" id="stringPropertyTypeSale" class="stringPropertyTypeSale">
                           <input type="hidden" name="city" class="stringCitySale">
                           <!--<input type="hidden" name="stype"  value="for sale">-->
                           <div class="select_buttons mb-3">
                              <div class="single_select_buttons select_icon">
                                 <select id="ptype_sale" multiple="multiple" class="form-select ptype_select" aria-label="Default select example">
                              ...
                              <div class="single_select_buttons select_icon">
                                 <select class="form-select" id="minprice_sale" name="minprice" aria-label="Default select example">
                                    <option value="">Min Price</option>
                                    ...
                                    <option value=""> R {{ number_format(450000,0," "," ")  }}</option>
                              ...
                              <div class="single_select_buttons select_icon">
                                 <select name="beds" class="form-select" id="beds_sale" aria-label="Default select example">
                                    <option value="">Beds</option>
                                    <option value="">Any</option>
                                     @for($gr=1; $gr <= 5; $gr++)
                              ...
                              <div class="single_select_buttons select_icon">
                                 <select id="bath_sale"  name="bath" class="form-select" aria-label="Default select example">
                                    <option value="">Baths</option>
                                    <option value="">Any</option>
                                     @for($hss=1; $hss <= 5; $hss++)
                              ...
                              <div class="single_select_buttons">
                                 <button type="button" id="moreOptionButtonCommercial" class="search-btn">More filter +</button>
                              </div>
                              <div id="moreAdvanceOptionSerachCommercial" style="">
                                  <div class="single_select_buttons select_icon">
                                 <select id="garage_sale" name="garage"  class="form-select" aria-label="Default select example">
                                    <option value="">Garage</option>
                                    <option value="">Any</option>
                                      @for($kld=1; $kld <= 5; $kld++)
                               ...
                               <div class="single_select_buttons select_icon">
                                 <select name="prkng" id="prkng_sale"  class="form-select" aria-label="Default select example">
                                    <option value="">Parking</option>
                                    <option value="">Any</option>
                                ...
                                <div class="single_select_buttons select_icon">
                                 <select name="fminsize" id="fminsize_sale"  class="form-select" aria-label="Default select example">
                                    <option value="">Floor Min Size (m²)</option>
                                        <option value="20"> 20</option>
                                        <option value="40"> 40</option>
                                        <option value="60"> 60</option>
                               ...
                               <div class="single_select_buttons select_icon">
                                 <select name="fmaxsize" id="fmaxsize_sale"  class="form-select" aria-label="Default select example">
                                    <option value="">Floor Max Size (m²)</option>
                                        <option value="20"> 20</option>
                                        <option value="40"> 40</option>
                                        <option value="60"> 60</option>
                           ...
                           <div class="recent-search d-flex align-items-center">
                            ...
                            <div class="searches">
                               @if(!empty($searchResultCookieForSale))
                                @for($ars = 0; $ars < count($searchResultCookieForSale); $ars++) <span class="badge"><a href="{{ $searchResultCookieForSale[$ars]['link'] }}" style="color:#222222">{{ $searchResultCookieForSale[$ars]['name'] }}</a></span>
                              @endfor
                               @else
                                 <span class="badge">no recent search</span>
                               @endif
         ...
         <div class="col-12 col-lg-4 mt-3 mt-lg-0">
             ...
             <img class="w-100 img-fluid" src="{{ asset('storage/banner_image/'.$setting->banner_image) }}" alt="property" onclick="window.open('{{ $setting->banner_link }}','_blank')" style="cursor:pointer">
         </div>
         @endif
          @endif
      </div>
