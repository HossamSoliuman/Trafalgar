                                                                    ...
                                                                    <td>
                                                                        <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;border-color: #ddd;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;vertical-align: baseline;">Property address</th>
                                                                                    <td style="word-break: break-all;padding-left: 15px;font-size: 15px;">{{  $details['property_address'] }}</td>
                                                                                </tr>
