@php $pageMeta = App\Models\StaticPageMetaTag::where('page_name','cape-town.property-to-rent-cbd-cape-town')->first(); @endphp
    ...
    <section class="guldenland_section about_page_content mt-2">
        <div class="container">
            <div class="heading h1_tag mb-4">
                <h1>Property To Rent In CBD, Cape Town</h1>
            </div>
