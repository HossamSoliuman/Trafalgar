                    ...
                    <div class="property_alert">
                        <div class="e-magazine-right-content">
                            <div class="each-magazine">
                                <div class="icon-div">
                                    <img style="cursor: pointer;" onclick="window.location='{{ route('email-property-alert') }}';" class="img-fluid" src="{{ asset('front/images/alert.png') }}" alt="email-property-alert">
                                </div>
                                <div class="magazine-content">
                                    <h4 style="cursor: pointer;" onclick="window.location='{{ route('email-property-alert') }}';" >Property Alerts</h4>
                            ...
                            <div class="each-magazine">
                                <div class="icon-div">
                                    <img style="cursor: pointer;" onclick="window.location='{{ route('sell') }}';" class="img-fluid" src="{{ asset('front/images/property.png') }}" alt="sell">
                                </div>
                                <div class="magazine-content">
                                    <h4 style="cursor: pointer;" onclick="window.location='{{ route('sell') }}';">List Your Property</h4>
                            ...
                            <div class="each-magazine">
                                <div class="icon-div">
                                    <img style="cursor: pointer;" onclick="window.location='{{ route('sell') }}#e-magazine';" class="img-fluid" src="{{ asset('front/images/valuation.png') }}" alt="valuation">
                                </div>
                                <div class="magazine-content">
                                    <h4 style="cursor: pointer;" onclick="window.location='{{ route('sell') }}#e-magazine';">Free Valution</h4>
