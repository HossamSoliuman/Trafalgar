            ...
            <div class="heading h1_tag mb-4">
                ...
                <div class="manage-paragraph">
                    <p>Trafalgar’s core business is the property management of sectional title schemes and Homeowners
                        Associations. Trafalgar understands that the management of a property directly affects peoples’
                        homes, lifestyles and the value of their primary assets, which is why we’re dedicated to providing a
                        comprehensive and tailored management service. With over 50-years experience, specialist systems and
                        professional staff, Trafalgar offers a complete property management service tailored to meet the
                        needs of individual schemes. We are fully registered with both the Property Practitioners Regulatory
                        Authority (PPRA) and the National Association of Managing Agents (NAMA). Please click <a
                            target="__blank"
                    ...
                    <p>Trafalgar offers a comprehensive property management service which can be conveniently tailored to
                        the specific needs and context of individual properties. Each property managed by Trafalgar is
                        allocated a dedicated residential portfolio manager as a single point of entry and primary
                        communication channel. All our portfolio managers are supported by a team consisting of a Property
                        Administrator, credit controller and bookkeeper as well as customised property management and
                        document management computer systems.</p>
                    <p>Effective financial management and reporting is a core component and competitive advantage of
                        Trafalgar’s property management service. Compiling and circulating detailed monthly management
                        reports including income statements, performance to budget and variance reports, levy rolls,
                        disbursement statements and credit control reports is a standard part of Trafalgar’s property
                        ...
                        file at year end to promote a time efficient and cost effective audit.</p>
                    <p>Monthly levy and utility payments are made easy for owners as our infrastructure provides for
                        ...
                        property specific web site we call the Property Portal linked to <a
                            href="/">www.trafalgar.co.za</a></p>
                </div>
            ...
            <div class="guldenland_products">
                <div class="guldenland_products_listing manage_section_listing">
                    <div class="each_manage_section">
                        <h4><a href="javascript:void(0)">Dedicated Portfolio Manager And The Property Management Team:</a>
                        </h4>
                        <ul>
                            <li>A dedicated and specialised team consisting of a portfolio manager, personal assistant,
                                credit controller and bookkeeper will be assigned to manage your homeowners association or
                                body corporate.</li>
                            <li>All portfolio managers are extensively trained in sectional title management and the
                                regulations of Non-profit companies and Common law Associations and will have complete a
                                number of property management courses.</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Distribution of monthly levy statements to owners: post, courier, email and internet options
                                available, although email is the preferred channel due to energy, convenience and green
                                friendly considerations</li>
                            <li>Collection of monthly levies: debit order, electronic banking, direct deposit, branch
                                deposit, credit card payment channel options available</li>
                            ...
                            <li>Trafalgar is a fully registered Debt Collector and is therefore governed by the Debt
                                Collectors Act. Credit control charges are therefore regulated and are charged directly to
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            ...
                            <li>All disbursements approved and signed off in accordance with Trustee/Director instructions
                                and relevant legislation</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Attendance at four (4) Trustees / Directors meetings per year as well as the Annual General
                                Meeting.</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Immediate advisory service regarding provisions of the Companies Act as well as the Scheme’s
                                Memorandum of Incorporation / Constitution and other relevant legislation</li>
                        </ul>
                    </div>
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li class="d-block">Maintenance of statutory records of the Homeowners Association including:
                                <ul class="pl-3 pt-1">
                                    ...
                                    <li>Conduct Rules and Memorandum of Incorporation / Constitution and Regulations thereto
                                    </li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Trafalgar offers a dedicated maintenance administrator supported by a specialised
                                maintenance computer information system to oversee the process of sourcing quotes, booking
                                maintenance work and following up with the contractors concerned.</li>
                            <li>All Trafalgar offices have panels of approved contractors as maintenance partners: their
                                workmanship and cost effectiveness has been positively tested from extensive prior
                                experience.</li>
                        </ul>
                    </div>
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Trafalgar’s website (www.trafalgar.co.za) offers our clients the opportunity to register
                                online in order to view their levy account detail at their leisure on the Internet.</li>
                            <li>Alternatively, levy statements and monthly management reports are available electronically
                                by email and circulated on a monthly basis.</li>
                            <li>Directors/trustees and owners of schemes managed by Trafalgar can also register for the
                                ‘Property Portal’ to view monthly income and expense reports, rules, plans, contact
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Trafalgar utilises a specialised property management computer system that operates in real
                                time – in other words all payments made or received show on the system immediately. In
                                addition, extensive development of the system over the last seven years has been undertaken
                                to ensure that system reports and functionality is optimised to keep in line with current
                                technology best practices.</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>On taking on a complex, a property management take-on specialist will be assigned to ensure
                                a smooth transition to Trafalgar.</li>
                            ...
                            <li>After a smooth take-on has been achieved, a portfolio manager will be selected by the
                                take-on specialist to continue with the ongoing management of the complex.</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            ...
                            <li>Referral to specialist attorneys to draft conduct rules and Memoranda of Incorporation or
                                necessary amendments</li>
                ...
                <div class="guldenland_sidebar">
                    ...
                    <div class="sidelist sociallinks_list">
                        <h4>Social Links</h4>
                        <ul>
                            <li><a href="<?php if ($setting->facebook_link) {
                                echo $setting->facebook_link;
                            } else {
                                echo '#';
                            } ?>"><img class="img-fluid"
                                        src="{{ asset('front/images/facebook.svg') }}" alt="facebook" /></a></li>
                            <li><a href="<?php if ($setting->twitter_link) {
                                echo $setting->twitter_link;
                            } else {
                                echo '#';
                            } ?>"><img class="img-fluid"
                                        src="{{ asset('front/images/twitter.svg') }}" alt="twitter" /></a></li>
                            <li><a href="<?php if ($setting->youtube_link) {
                                echo $setting->youtube_link;
                            } else {
                                echo '#';
                            } ?>"><img class="img-fluid"
                                        src="{{ asset('front/images/youtube.svg') }}" alt="youtube" /></a></li>
                            <li><a href="<?php if ($setting->linkedin_link) {
                                echo $setting->linkedin_link;
                            } else {
                                echo '#';
                            } ?>"><img class="img-fluid"
                                        src="{{ asset('front/images/linkedin.svg') }}" alt="linkedin" /></a></li>
                            <li><a href="<?php if ($setting->instagram_link) {
                                echo $setting->instagram_link;
                            } else {
                                echo '#';
                            } ?>"><img class="img-fluid"
                                        src="{{ asset('front/images/instagram.svg') }}" alt="instagram" /></a></li>
                        </ul>
                    </div>
                    <div class="sidelist contact_sidelist">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Name" required
                                            id="letter_name" name="letter_name">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="email" class="form-control" placeholder="Email" required
                                            id="letter_email" name="letter_email">
                                    </div>
                                </div>
                                <div class="col-12">
