      ...
      <div class="row">
          ...
          <div class="col-6 pl-2">
              <div class="form-group">
                  ...
                  <input type="text" required="" class="form-control" placeholder="Enter phone" id="phone"
                      name="phone">
              </div>
          </div>
          ...
          @elseif($route == 'manage.sectional-title-and-hoa-management')
              <input type="hidden" required name="pagename" value="sectional title and hoa management contact form">
          @elseif($route == 'manage.commercial-property-management')
              <input type="hidden" required name="pagename" value="commercial property management contact form">
          @elseif($route == 'manage.estate-management')
              <input type="hidden" required name="pagename" value="estate management contact form">
          @elseif($route == 'manage.sectional-title-and-hoa-management.developer-services')
              <input type="hidden" required name="pagename" value="developer services contact form">
          ...
          @elseif($route == 'rent.vacancy-marketing')
              <input type="hidden" required name="pagename" value="vacancy marketing contact form">
          @elseif($route == 'rent.tenant-screening')
              <input type="hidden" required name="pagename" value="tenant screening contact form">
