@php $checkPageType = Request::segment(2) ;  
@endphp

@if($checkPageType != "multiple-areas")
@section('meta_keywords','COMMERCIAL CITY TO RENT')
@php if(isset($_GET['city'])){ $cityTitle = $_GET['city']; }else{ $cityTitle = $checkPageType; }  @endphp
@php if(isset($_GET['city'])){ $cityDesc = $_GET['city']; }else{ $cityDesc = $checkPageType; }  @endphp

@section('title','Commercial Property to rent in '.$cityTitle.'')
@section('meta_description',"Commercial Property to rent in ".$cityDesc.", 'The largest selection of office, retail & industrial property in ".$cityDesc)


@else
@section('meta_keywords','COMMERCIAL MULTIPLE SUBURBS TO RENT')
@section('title','Commercial property to rent in Multiple Suburbs')
@section('meta_description','Commercial property to rent in Multiple Suburbs. A selection of office, retail & industrial property to rent.')
@endif
...
@section('content')
      ...
      <div class="row">
         <div class="col-12 col-lg-8 pr-0">
             <div class="heading h1_tag">
               <h1>Find a Commercial Property</h1>
            </div>
                ...
                @endif
                    ...
                    <form action="{{ route('property') }}" method="get" id="searchForm" class="resetFormData">
                       <div class="input-group mb-3 search_view">
                            <div class="input-group-prepend selectwithinput">
                                <div class="select_buttons">
                                    <div class="single_select_buttons select_icon">
                                        ...
                                        <select  id="stype"  class="form-select" aria-label="Default select example">
                          ...
                          <select id="cityListForSearchPage"  class="select2 form-control search-input" multiple="multiple" data-placeholder="Enter a province, city or suburb, Multiple areas may be entered." onchange="getData()">
                              ...
                              if(isset($arrayOfCity) && $arrayOfCity == $getSearchTaggerData[$key_check]['text']){ echo "selected"; 
        } 
       ...
       if($url_city == 3 && $url_town == 3 && $url_province == 3){
        ...
        ?>><?php echo $getSearchTaggerData[$key_check]['text']; ?> </option>
                          ...
                          <div class="input-group-append">
                             <button  class="btn btn-outline-secondary search-btn propertySearchButton button-addon2" type="button"
                       ...
                       <input type="hidden" name="city" class="stringCity">
                         ...
                         <input type="hidden"  name="ptype" class="stringPropertyTypeRent" id="stringPropertyTypeRent">
                       ...
                       <div class="select_buttons mb-3">
                          <div class="single_select_buttons select_icon">
                             <select id="ptype_rent" multiple="multiple" class="form-select ptype_select" aria-label="Default select example">
                               
                                  @foreach($propertyTypeList as $propertyTypeListss)
                                    <option <?php if(isset($arrayOfPropertyType) && in_array( $propertyTypeListss->property_type,$arrayOfPropertyType)){ echo "selected"; 
        }   ?> value="{{ $propertyTypeListss->property_type  }}">{{ ucfirst($propertyTypeListss->property_type)  }}</option>
                                @endforeach
                          ...
                          <div class="single_select_buttons select_icon" id="minprice_rent_select">
                             <select name="minprice" id="minprice_rent" class="form-select" aria-label="Default select example">
                          ...
                          <div class="single_select_buttons select_icon" id="maxprice_ren_select">
                             <select name="maxprice" id="maxprice_rent" class="form-select" aria-label="Default select example">
                          ...
                          <div class="single_select_buttons select_icon" id="minprice_sale_select">
                             <select name="minprice" id="minprice_sale" class="form-select" aria-label="Default select example">
                                <option value="">Min Price</option>
                          ...
                          <div class="single_select_buttons select_icon" id="maxprice_sale_select">
                             <select name="maxprice" id="maxprice_sale" class="form-select" aria-label="Default select example">
                                <option value="">Max Price</option>
                          ...
                          <div class="single_select_buttons select_icon">
                             <select name="beds" id="beds_rent" class="form-select" aria-label="Default select example">
                          ...
                          <div class="single_select_buttons select_icon">
                             <select name="bath" class="form-select" id="bath_rent" aria-label="Default select example">
                          ...
                          <div class="single_select_buttons">
                             <button type="button" id="moreOptionButtonRent" class="search-btn">More filters +</button>
                          </div>
                            <div id="moreAdvanceOptionSerachRent" style="">
                                <div class="single_select_buttons select_icon">
                                 <select name="garage" id="garage_rent" class="form-select" aria-label="Default select example">
                                ...
                                <div class="single_select_buttons select_icon">
                                 <select name="prkng" id="prkng_rent"  class="form-select" aria-label="Default select example">
                                ...
                                <div class="single_select_buttons select_icon">
                                 <select name="fminsize" id="fminsize_rent"  class="form-select" aria-label="Default select example">
                               ...
                               <div class="single_select_buttons select_icon">
                                 <select name="fmaxsize" id="fmaxsize_rent"  class="form-select" aria-label="Default select example">
                    ...
                    <input type="hidden" id="citycommercialdata" name="citycommercialdata"/>
                       ...
                       <div class="recent-search d-flex align-items-center">
                          ...
                          <div class="searches">
                               @if(!empty($searchResultCookie))
                                @for($ar = 0; $ar < count($searchResultCookie); $ar++) <span class="badge"><a href="{{ $searchResultCookie[$ar]['link'] }}" style="color:#222222">{{ $searchResultCookie[$ar]['name'] }}</a></span>
                              @endfor
                               @else
    ...
    <section class="guldenland_section">
        <div class="container">
            <div class="heading mb-4">
               ...
               @endphp
               <h2>Property To Rent in <?php if( (isset($_GET['city']) && $_GET['city'] !="")){ echo $text; } ?></h2>
            </div>
                ...
                <div class="guldenland_products_listing">
                    ...
                    <div class="order_grid_view">
                        ...
                        <div class="list_map_view">
                            ...
                            <a class="list_view" id="showListDiv" href="#"><img class="img-fluid" src="{{ asset('front/images/list.png') }}" alt="list.png"/></a>
                            <a class="map_view" id="showMapDiv" href="javascript:void(0)"><img class="img-fluid" src="{{ asset('front/images/map.png') }}" alt="map.png" /></a>
                        </div>
                    </div>
                            ...
                            <div style="cursor: pointer;" onclick="window.location = '{{ $customUrl }}';" class="guldenland_each_product">
                                <div class="product_img">
                                   <a title="{{ $propertyData->complex_name." ".$propertyData->unit_number }}" href="{{ $customUrl }}">
                                        ...
                                        <img class="img-fluid" src="{{ $propertyData->news_featured_image }}" alt="{{ $propertyData->news_featured_image }}" />
                                         @else
                                   <img title="{{ $propertyData->complex_name." ".$propertyData->unit_number }}" class="img-fluid" src="{{ asset('storage/propertyDummyImage/dummy_property_image.jpg') }}"  alt="dummy_property_image.jpg" />
                                   @endif
                                        
                                        </a>
                                </div>
                                <div class="product_content">
                                    <h4 title="R {{ number_format($propertyData->price,0," "," ")  }}">R {{ number_format($propertyData->price,0," "," ")  }}<sub class="per_month">per month</sub></h4>
           ...
           <a title="{{ ucwords($propertyData->complex_name)." ".$propertyData->unit_number }}" href="{{ $customUrl }}">
         <h3> {{ ucwords($propertyData->complex_name) }}</h3>
         <!--." ".$propertyData->unit_number-->
          </a>
         @else
          <a title="{{ ucwords($propertyData->street_name)." ".$propertyData->street_number }}" href="{{ $customUrl }}">
         <h3> {{ ucwords($propertyData->street_name) }}
         ...
         @endif
                                    ...
                                    <div class="product_detail">
                                        ...
                                        <span title="{{ $propertyData->bedrooms }} Bedroom" ><img src="{{ asset('front/images/icon_bed_new.png') }}" alt="icon_bed_new.png" />{{ $propertyData->bedrooms }} Bedroom</span>
                                        @endif
                                          @if($propertyData->bathrooms > 0)
                                        <span title="{{ $propertyData->bathrooms }} Bathroom" ><img src="{{ asset('front/images/icon_bath_new.png') }}" alt="icon_bath_new.png">{{ $propertyData->bathrooms }} Bathroom</span>
                                         @endif
                                           @if($propertyData->garages > 0)
                                        <span title="{{ $propertyData->garages }} Garage" ><img src="{{ asset('front/images/icon_parking.png') }}" alt="icon_parking.png" /> {{ $propertyData->garages }} Garage</span>
                                           @endif
                                             @if($propertyData->floor_size > 0)
                                        <span title="{{ $propertyData->floor_size }}{{ $propertyData->floor_size_unit }}"><img src="{{ asset('front/images/icon_floor_new.png') }}" alt="icon_floor_new.png" /><small>{{ $propertyData->floor_size }} <sup>{{ $propertyData->floor_size_unit }}</sup></small></span>
                                        @endif
                                    </div>
                                    @endif
                                </div>
                ...
                <div class="guldenland_sidebar">
                    ...
                    <div class="sidelist">
                        ...
                        <h4> @if(!empty($cityArray)) <?php  //echo $cityArray[0] ?> @endif  Commercial property for rent  </h4>
                        <ul>
                            @foreach($sideBarCodeForSearch as $sideBarCodeForSearchs)
                            @if($cityArray[0] != "")
                            <li><a href="{{ route('commercial-property-for-rent',['url_city'=> str_replace(' ','-',$sideBarCodeForSearchs->suburb) , 'url_town'=> str_replace(' ','-',$sideBarCodeForSearchs->town) , 'url_province'=> str_replace(' ','-',$sideBarCodeForSearchs->province) ,'city'=> $cityArray[0],'ptype' =>$sideBarCodeForSearchs->property_type  ]) }}"> {{ ucfirst($sideBarCodeForSearchs->property_type) }} property for rent in {{$sideBarCodeForSearchs->town }}  </a></li>
                            @endif
                            @endforeach
                        </ul>
                        @endif
                    ...
                    <div class="property_alert">
                        <div class="e-magazine-right-content">
                            <div class="each-magazine">
                                <div class="icon-div">
                                    <img class="img-fluid" src="{{ asset('front/images/alert.png') }}" alt="alert.png" />
                                </div>
                                <div class="magazine-content">
                                    <h4>Property Alerts</h4>
                                    <p><a href="{{ route('email-property-alert') }}">Sign up</a> for your customised property alerts delivered
                                        directly to your inbox.</p>
                                </div>
                            </div>
                            <div class="each-magazine">
                                <div class="icon-div">
                                    <img class="img-fluid" src="{{ asset('front/images/property.png') }}" alt="property.png" />
                                </div>
                                <div class="magazine-content">
    ...
    <section class="footer_top_section footer_top_section_bgwhite">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer_top_content">
                            <h5>Commercial Property for Rent</h5>
      ...
      $customUrl_distinct = route('commercial-property-for-rent',['url_city'=>$suburb_distinct,'url_town'=>$town_distinct,'url_province'=>$province_distinct,'city'=>$getDistinctSuburbs->suburb]);
...
@push('property-search-commercial-rent-list-js')
@include('frontPart.js.propertySearchCommercialRentListJs')
@endpush
