...
<html>
<head>
 <title>Enquiry for Property - {{ $details['getId'] }}</title>
</head>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;border-color: #ddd;">
                                                                            <tbody>
                                                                    <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">From</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;"> {{ $details['your_name'] }}</td>
                                                                                </tr>
                                         
                                                                                <tr>
                                                                                    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Property Link</th>
                                                                                    <td style="padding-left: 15px;font-size: 15px;">{{ $details['shareableLink'] }}</td>
                                                                                </tr>
                                                                                <!--<tr>-->
                                                                                <!--    <th style="text-align:left;padding-right:30px;background: #690b10;color: #fff;font-size: 15px;">Email</th>-->
                                                                                <!--    <td style="padding-left: 15px;font-size: 15px;"></td>-->
                                                                                <!--</tr>-->
                                                                                <!--<tr>-->
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="word-break: break-all;padding-left: 15px;font-size: 15px;">{{ $details['your_message'] }}</td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
