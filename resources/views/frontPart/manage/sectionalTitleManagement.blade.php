            ...
            <div class="guldenland_products">
                <div class="guldenland_products_listing manage_section_listing">
                    <div class="each_manage_section">
                        <h4><a href="javascript:void(0)">Dedicated Sectional Title Portfolio Manager And The Property Management Team:</a></h4>
                        <ul>
                            <li>A dedicated and specialised team consisting of a sectional title portfolio manager, Portfolio Administrator, debt collector and accountant will be assigned to manage your body corporate</li>
                            <li>All portfolio managers are extensively trained in sectional title management and will have completed a variety of relevant training courses together with a variety of in house courses</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Distribution of monthly levy statements to owners by post, courier, email and internet options are all available, although email is the preferred channel due to energy, convenience and green friendly considerations</li>
                            <li>Collection of monthly levies by debit order, electronic banking, direct deposit and branch deposit are all available, while credit card payment service is provided at selected branches</li>
                            <li>Credit control of all outstanding levies</li>
                            <li>Trafalgar is a fully registered Debt Collector and is therefore governed by the Debt Collectors Act. Debt collection charges are therefore regulated and are charged directly to the levy defaulter and recovered directly from the individual and not from the Body Corporate. As a registered Debt Collector, we are able to blacklist levy defaulters which affects their credit rating.</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            ...
                            <li>All disbursements approved and signed off in accordance with Trustee instructions and the relevant legislation</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Attendance at four (4) trustees meetings per year as well as the Annual General Meeting.</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Immediate advisory service regarding provisions of the Sectional Title legislation and other relevant legislation</li>
                        </ul>
                    </div>
                    <div class="each_manage_section">
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>Maintenance administration to arrange quotes, booking contractors and facilitating invoice approval by a dedicated maintenance administrator</li>
                            <li>All Trafalgar offices have panels of preferred contractors as maintenance partners: their workmanship, regulatory body registration, insurance and labour legislation compliance and cost effectiveness has been positively tested from extensive prior experience.</li>
                        </ul>
                    </div>
                    <div class="each_manage_section">
                        <h4><a href="javascript:void(0)">Internet And E-Mail:</a></h4>
                        <ul>
                            <li>Trafalgar’s website (www.trafalgar.co.za) offers our clients the opportunity to register online in order to view their levy account details</li>
                            <li>Trustees and owners of sectional title schemes managed by Trafalgar can also register for the ‘Property Portal’ to view monthly income and expense reports, rules, plans, contact information and other relevant property management information.</li>
                        </ul>
                    </div>
                    <div class="each_manage_section">
                        <h4><a href="javascript:void(0)">Computer Systems:</a></h4>
                        <ul>
                            <li>Trafalgar utilises a specialised property management computer information system that operates in real time – in other words all payments made or received show on the system immediately. In addition, extensive development of the system over the last seven years has been undertaken to ensure that system reports and functionality is optimised to keep in line with current technology best practices.</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            <li>On taking on a complex, a sectional title take-on specialist will be assigned to ensure a smooth transition to Trafalgar.</li>
                            ...
                            <li>After a smooth take-on has been achieved, a sectional title portfolio manager will be selected by the take-on specialist to continue with the ongoing management of the complex.</li>
                            ...
                            <li class="d-block">The Health Check includes:
                                <ul class="pl-3 pt-1">
                                    <li>Deeds search to confirm that correct owners and their details are loaded for levy billing and communication purposes</li>
                    ...
                    <div class="each_manage_section">
                        ...
                        <ul>
                            ...
                            <li>Referral to specialized sectional title attorneys where necessary to update and modernize conduct rules, together with guidance on how to approve updated conduct rules after drafting</li>
